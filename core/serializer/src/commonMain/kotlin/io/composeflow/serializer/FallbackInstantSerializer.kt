...
private object FallbackInstantSerializerInternal : KSerializer<Instant> {
 ...
 */
class FallbackInstantSerializer : KSerializer<Instant> {
    private val delegate = FallbackInstantSerializerInternal.withLocationAwareExceptions()
