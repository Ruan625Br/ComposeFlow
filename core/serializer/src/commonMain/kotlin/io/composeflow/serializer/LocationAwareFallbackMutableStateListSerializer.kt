...
private class FallbackMutableStateListSerializer<T>(
 ...
 */
class LocationAwareFallbackMutableStateListSerializer<T>(
    dataSerializer: KSerializer<T>,
) : KSerializer<MutableList<T>> {
    private val delegate =
        FallbackMutableStateListSerializer(dataSerializer).withLocationAwareExceptions()
