...
public val ComposeFlowIcons.EditfolderDark: ImageVector
    get() {
        if (_editfolderDark != null) {
            return _editfolderDark!!
        }
        _editfolderDark = Builder(name = "EditfolderDark", defaultWidth = 16.0.dp, defaultHeight =
...
private var _editfolderDark: ImageVector? = null
