...
public val ComposeFlowIcons.Datacolumn: ImageVector
    get() {
        if (_datacolumn != null) {
            return _datacolumn!!
        }
        _datacolumn = Builder(name = "Datacolumn", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var _datacolumn: ImageVector? = null
