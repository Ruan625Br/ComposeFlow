...
class GoogleCloudStorageWrapper {
    ...
    ): Result<BlobInfoWrapper?, Throwable> = runCatching {
        file.path?.let { filePath ->
            val blobInfo = uploadFileWithPath(
    ...
    suspend fun uploadFile(
        ...
        val blobInfo = uploadFileWithContent(
    ...
    suspend fun listFile(
        userId: String,
    ): Result<List<BlobInfoWrapper>, Throwable> = runCatching {
