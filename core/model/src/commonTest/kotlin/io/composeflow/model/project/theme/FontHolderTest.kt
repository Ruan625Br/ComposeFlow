...
class FontHolderTest {
    ...
    fun testCopyContents() {
        ...
        source.textStyleOverrides[TextStyleWrapper.DisplayLarge] = TextStyleOverride(
            fontSize = 32,
            letterSpacing = 1.5f,
            fontWeight = FontWeightWrapper.Bold,
            fontFamilyCandidate = FontFamilyCandidate.Secondary
        )
        source.textStyleOverrides[TextStyleWrapper.BodyMedium] = TextStyleOverride(
            fontSize = 16,
    ...
    fun testCopyContentsCompleteOverwrite() {
        ...
        source.textStyleOverrides[TextStyleWrapper.LabelSmall] = TextStyleOverride(
            fontSize = 12,
            letterSpacing = 0.5f
        )
