...
public val ComposeFlowIcons.HttpRequestsFiletype: ImageVector
    get() {
        if (_httpRequestsFiletype != null) {
            return _httpRequestsFiletype!!
        }
        _httpRequestsFiletype = Builder(name = "HttpRequestsFiletype", defaultWidth = 16.0.dp,
...
private var _httpRequestsFiletype: ImageVector? = null
