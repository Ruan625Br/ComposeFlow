...
public val ComposeFlowIcons.Editfolder: ImageVector
    get() {
        if (_editfolder != null) {
            return _editfolder!!
        }
        _editfolder = Builder(name = "Editfolder", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var _editfolder: ImageVector? = null
