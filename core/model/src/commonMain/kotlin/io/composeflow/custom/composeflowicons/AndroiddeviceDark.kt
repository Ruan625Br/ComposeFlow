...
public val ComposeFlowIcons.AndroiddeviceDark: ImageVector
    get() {
        if (_androiddeviceDark != null) {
            return _androiddeviceDark!!
        }
        _androiddeviceDark = Builder(name = "AndroiddeviceDark", defaultWidth = 16.0.dp,
...
private var _androiddeviceDark: ImageVector? = null
