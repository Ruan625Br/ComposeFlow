...
public val ComposeFlowIcons.ColorsDark: ImageVector
    get() {
        if (_colorsDark != null) {
            return _colorsDark!!
        }
        _colorsDark = Builder(name = "ColorsDark", defaultWidth = 14.0.dp, defaultHeight = 14.0.dp,
            ...
            path(fill = SolidColor(Color(0xFFF2C55C)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(7.0f, 1.0f)
            ...
            path(fill = SolidColor(Color(0xFFDB5C5C)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(7.0f, 8.0f)
