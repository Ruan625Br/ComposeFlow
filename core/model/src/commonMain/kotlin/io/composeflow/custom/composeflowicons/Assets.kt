...
public val ComposeFlowIcons.Assets: ImageVector
    get() {
        if (_assets != null) {
            return _assets!!
        }
        _assets = Builder(name = "Assets", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFFEBECF0)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(9.8954f, 8.0f, 9.0f, 8.8954f, 9.0f, 10.0f)
            ...
            path(fill = SolidColor(Color(0xFF3574F0)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(11.0f)
                curveTo(10.4477f, 16.0f, 10.0f, 15.5523f, 10.0f, 15.0f)
