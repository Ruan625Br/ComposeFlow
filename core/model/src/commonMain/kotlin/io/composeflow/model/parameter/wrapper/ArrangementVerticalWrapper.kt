...
enum class ArrangementVerticalWrapper(val arrangement: Arrangement.Vertical) {
    Top(Arrangement.Top),
    ...
    companion object {
        fun fromArrangement(arrangement: Arrangement.Vertical?) =
            entries.firstOrNull { it.arrangement == arrangement } ?: Top
    }
}
