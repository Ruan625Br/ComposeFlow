        ...
        open fun convertDiscriminatedInterface(
            ...
            if (subclassesDescriptorToInterface.isEmpty() || discriminatorName.isNullOrBlank()) {
                ...
                val discriminatorEnum = run {
                    ...
                    val members =
                        subclassesDescriptorToInterface.entries.map { (descriptor, tsInterface) ->
                ...
                val discriminatorEnumRef =
                    TsTypeRef.Declaration(discriminatorEnum.id, namespaceRef, false)

                // add discriminator property to subclasses
                val subInterfacesWithTypeProp =
                    subclassesDescriptorToInterface.map { (_, subclass) ->

                        val subclassId =
                            TsElementId(namespaceId.toString() + "." + subclass.id.name)
                        ...
                        val literalTypeProperty =
                            TsProperty(discriminatorName, literalTypeRef, false)
