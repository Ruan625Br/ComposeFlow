...
:::note
At the moment, only Google social login is enabled as a auth provider. But they'll be added in the future release.
:::
...
- **Provide Password Reset Option**:
    ...
    - Assign the **"Reset Password"** action to initiate a password reset email.
