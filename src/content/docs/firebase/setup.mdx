...
:::note
Connecting to the Firebase project may require additional permission browder than signing in with
ComposeFlow. This step may require you to grant additional scope by opening the browser.
:::
