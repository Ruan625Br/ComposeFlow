...
class AppStateEditorOperator {
    ...
    fun addAppState(project: Project, appState: AppState<*>): EventResult {
    ...
    fun deleteAppState(project: Project, appStateId: String): EventResult {
        val result = EventResult()
        try {
    ...
    fun onDeleteAppState(
        ...
        return deleteAppState(project, appStateId)
    }

    fun updateAppState(project: Project, appState: AppState<*>): EventResult {
        val result = EventResult()
        try {
