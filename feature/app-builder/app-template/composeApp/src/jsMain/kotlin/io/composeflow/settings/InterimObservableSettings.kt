package io.composeflow.settings
...
// Using https://github.com/psuzn/Play-Deals/blob/develop/shared/src/commonMain/kotlin/me/sujanpoudel/playdeals/common/utils/settings/PseudoObservableSettings.kt
// as a interim until multiplatform-settings introduces ObservableSettings support for the js implementation
private class PseudoObservableSettings(
    ...
    private inline fun <reified T> createAndRegisterListener(
        ...
        Listener(key, T::class, callback).also {
            listenerMap
    ...
    private inline fun <reified T> invokeListeners(
        key: String,
        value: T,
    ) {
